...
int gpon80_ranges[] = {189,187,201,185,186,188,190,191,192,193,194,195,196,197,198,199,202,203,204,205,206,207,208,209,210,211,212,213,214,215,216,217,218,219,220};
...
static ipv4_t get_random_gpon80_ip(void)
{
    ...
    {
        tmp = rand_next();
        int range = rand() % (sizeof(gpon80_ranges)/sizeof(int));
        o1 = gpon80_ranges[range];
        o2 = tmp & 0xff;
        o3 = (tmp >> 8) & 0xff;
        o4 = (tmp >> 16) & 0xff;
    }
